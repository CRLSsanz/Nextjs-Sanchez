...
const Page = () => {
  return (
    <div className={inter.className}>
      ...
      <section className="flex flex-col justify-between bg-gray-100">
        <div className=" text-gray-200">
          <div className="bg-cover bg-center bg-[url('/images/clases1.jpg')] h-40">
          ...
          <div className="lg:flex lg:justify-center bg-gray-100 px-4 pb-10">
            <div className="lg:w-[1100px] bg-white rounded-xl p-4">
              <div className="lg:flex lg:flex-row">
                <div className="lg:w-2/3 mb-5 lg:mb-0">
                  <Image
                    ...
                    height={500}
                    alt="Clases"
                    className="lg:w-full lg:pr-5 rounded-lg"
                  />
                </div>

                <div className="lg:w-1/3 bg-gradient-to-br from-cyan-400 to-blue-500  p-4 text-white rounded-lg">
              ...
              <div className="text-gray-800 lg:flex lg:flex-row lg:justify-between my-5">
                <div className="flex flex-row items-center mb-5 lg:mb-0 lg:mt-5">
              ...
              <div className="flex justify-center mb-10 lg:pt-5">
                <a
                  href="#cursos"
          ...
          {/** CURSOS IMAGENES */}
          <div className="lg:flex lg:justify-center bg-gray-100  text-gray-600">
            <div className="lg:w-[1100px] bg-white lg:rounded-t-xl">
              <div className="flex justify-center">
                <h1 className="border-r-2 h-12 mb-10 border-orange-500"></h1>
              </div>
              <div className="text-4xl px-5 lg:px-10 mb-5">
                Aprenda nuevas habilidades con nuestros cursos de Microsoft 365
              </div>
              <p className="px-5 lg:px-10 mb-5">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3  gap-4 p-5 lg:px-10">
                <Image
          ...
          <div
            id="cursos"
            className="lg:flex lg:justify-center bg-white lg:bg-gray-100 text-gray-600 py-10 lg:pt-0"
          >
            <div className="lg:w-[1100px] lg:bg-white p-5 lg:px-10 mb-10 lg:rounded-b-xl">
              <div className="mt-10">
      ...
      <section className="bg-fixed bg-cover bg-center bg-[url('/images/curso/curso-basico.jpg')] h-[calc(85vh)]">
        <div className="lg:flex lg:justify-center w-full h-full bg-gray-900/70">
          <div className="lg:w-[600px] h-full text-center text-gray-200 px-10 flex flex-col justify-center items-center">
      ...
      <section className="hidden lg:flex lg:flex-col lg:items-center lg:justify-center bg-gray-900 text-gray-300 pt-20">
        <div className="lg:w-[600px]">
          <div className="px-10 mb-10">
            ...
            <p className="pr-16">
              ...
              calidad a cada uno de sus clientes.
            </p>
            ...
            <div className="mt-10">
              ...
              <div className="flex items-center">
                ...
                <span className="ml-2">Presencia en Lima - Perù</span>
              </div>

              <div className="flex flex-wrap gap-4 justify-center text-gray-300 py-5">
                <div className="bg-transparent border border-gray-300 rounded-full w-6 h-6 flex">
                  <svg
                    className="m-auto"
                    stroke="currentColor"
                    fill="currentColor"
        ...
        <div className="w-full bg-gray-950 text-center py-5">
