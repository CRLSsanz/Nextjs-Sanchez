            ...
            <div className="h-full p-4 bg-white rounded mr-4">
              ...
              <div className="">
                ...
                <div className="text-sm text-gray-400">
                  <h1 className="">Dimenciones: 34" 29" 27" 25"</h1>
                  <h1 className="">Resolucion: UHD QHD 2K 4K</h1>
                  <h1 className="">Marca: ACER ASUS HP LG SAMSUMG</h1>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="">
            <div className="h-full p-4 bg-white rounded mr-4">
              ...
              <div className="">
                ...
                <div className="text-sm text-gray-400">
                  <h1 className="">Dimenciones: 27" 25" 22" 19"</h1>
                  <h1 className="">Resolucion: HD UHD 2K </h1>
                  <h1 className="">Marca: ACER DELL HP LG SAMSUMG</h1>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="pl-6">
            <div className="h-full p-4 bg-white rounded mr-4">
              ...
              <div className="">
                ...
                <div className="text-sm text-gray-400">
                  <h1 className="">Tecnologia : DDR5 SDRAM</h1>
                  <h1 className="">Dimenciones : 16GB 32GB</h1>
                  <h1 className="">Transferencia : 4800Mhz 5600Mhz</h1>
          ...
          <div className="">
            <div className="h-full p-4 bg-white rounded mr-4">
              ...
              <div className="">
                ...
                <div className="text-sm text-gray-400">
                  <h1 className="">Tecnologia : DDR4 SDRAM</h1>
                  <h1 className="">Dimenciones : 8GB 16GB</h1>
                  <h1 className="">Transferencia : 2400 3200 3600</h1>
                  <div className="flex flex-row">
                    <h1 className="mr-1 inline text-nowrap">Marca :</h1>
                    <h1 className="uppercase">
          ...
          <div className="">
            <div className="h-full p-4 bg-white rounded mr-4">
              ...
              <div className="">
                ...
                <div className="text-sm text-gray-400">
                  <h1 className="">Tecnologia : DDR3 SDRAM</h1>
                  <h1 className="">Dimenciones : 4GB 8GB</h1>
                  <h1 className="">Transferencia : 1333Mhz 1600Mhz </h1>
                  <div className="flex flex-row">
                    <h1 className="mr-1 inline text-nowrap">Marca :</h1>
                    <h1 className="uppercase">
          ...
          <div className="">
            <div className="h-full p-4 bg-white rounded mr-4">
              ...
              <div className="">
                ...
                <div className="text-sm text-gray-400">
                  <h1 className="">Tecnologia : DDR3 DDR4 SDRAM</h1>
                  <h1 className="">Dimenciones : 4GB 8GB 16GB</h1>
                  <h1 className="">Transferencia : 1600 - 2400 - 3200 </h1>
                  <div className="flex flex-row">
                    <h1 className="mr-1 inline text-nowrap">Marca :</h1>
                    <h1 className="uppercase">
